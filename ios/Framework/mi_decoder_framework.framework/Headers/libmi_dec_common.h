...
#define MI_DEC_MAX_TIMESCALE 0x0FFFFFFF
#define MI_DEC_DEF_TIMESCALE 1000
...
#ifdef MIDEC_DYNAMIC
#ifdef _EXPORT
#define MIDEC_EXPORT __declspec(dllexport)
#else
#define MIDEC_EXPORT __declspec(dllimport)
#endif
#else
#define MIDEC_EXPORT
#endif
